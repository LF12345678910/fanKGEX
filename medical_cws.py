...
class medical_seg(object):
    def __init__(self):
        self.NEWPATH = 'D:/A_TheStoragePool/MyDirection/KnowledgeGraph/MyCode/KgExtract/fanKGEX/model/cws/medical_cws/pytorch_model.pkl'
        ...
        self.vocab = load_vocab(r'D:\A_TheStoragePool\MyDirection\KnowledgeGraph\MyCode\KgExtract\fanKGEX\model\cws\medical_cws\vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF(r'D:\A_TheStoragePool\MyDirection\KnowledgeGraph\MyCode\KgExtract\fanKGEX\model\cws\medical_cws', tagset_size, 768, 200, 2,
    ...
    def predict_sentence(self, sentence):
        ...
        self.model.load_state_dict(torch.load(self.NEWPATH,map_location=self.device),strict=False)
        self.model.eval()
