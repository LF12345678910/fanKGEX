...
class medical_ner(object):
    def __init__(self):
        self.NEWPATH = r'D:\A_TheStoragePool\MyDirection\KnowledgeGraph\MyCode\KgExtract\fanKGEX\model\ner\medical_ner\model.pkl'
        self.vocab = load_vocab(r'D:\A_TheStoragePool\MyDirection\KnowledgeGraph\MyCode\KgExtract\fanKGEX\model\ner\medical_ner\vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF(r'D:\A_TheStoragePool\MyDirection\KnowledgeGraph\MyCode\KgExtract\fanKGEX\model\ner\medical_ner', tagset_size, 768, 200, 2,
